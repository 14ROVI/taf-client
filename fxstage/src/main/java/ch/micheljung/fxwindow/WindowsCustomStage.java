...
class WindowsCustomStage {
  ...
  public static void configure(WindowController controller, Features features) {
    ...
    if (System.getProperty("os.arch").endsWith("64")) {
      ...
      BaseTSD.LONG_PTR defaultWindowsProcedure = new BaseTSD.LONG_PTR(user32Ex.GetWindowLong(hwnd, GWL_WNDPROC));
      user32Ex.SetWindowLong(hwnd, GWL_WNDPROC, new DecorationWindowProcedure(controller, defaultWindowsProcedure, features));
    }
